...
class MovieGenreNetworkResourceTest {
    ...
    private lateinit var sut: MovieGenreNetworkResource
    ...
    fun testTvGenreErrorUnauthResponse() {
        ...
        assertDoesNotThrow {
            ...
            error.dataResponse.run {
                ...
                assertEquals(MOVIE_GENRE_API_TAG, apiTag)
            }
            verifyZeroInteractions(dataManager)
        }
    }
