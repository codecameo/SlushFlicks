...
class TrendingTvRepositoryImplTest {
    ...
    private lateinit var sut: TrendingTvRepositoryImpl
    ...
    fun testTvShowCastNoInternet() {
        // Arrange
        val tag = ApiTag.TRENDING_TV_API_TAG
    ...
    fun testTvShowList() {
        ...
        assertDoesNotThrow {
            mainCoroutineDispatcher.runBlockingTest {
                //Act
                val actual =
                    sut.getPagingTvList(boundaryCallback).getOrAwaitValue() as Success
