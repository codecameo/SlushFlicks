...
class MovieListNetworkResourceTest {
    ...
    private lateinit var sut: MovieListNetworkResource
    ...
    @Test
    fun testMovieErrorResponseNoInternet() {
        initSut(1)
        ...
        assertDoesNotThrow {
            ...
            actual.dataResponse.run {
                ...
                assertEquals(this@MovieListNetworkResourceTest.apiTag, apiTag)
